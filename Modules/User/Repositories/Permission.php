...
class Permission
{
    ...
    private static function getEnabledModulePermissions()
    {
        ...
        foreach (Module::allEnabled() as $module) {
            $config = config('greensintl.modules.' . strtolower($module->getName()) . '.permissions');
    ...
    {
        $permissions = config('greensintl.themes.' . strtolower(setting('active_theme')) . '.permissions');
