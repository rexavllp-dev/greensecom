...
GreensIntl.dataTable = { routes: {}, selected: {} };
...
export default class {
    constructor(selector, options, callback) {
        ...
        if (GreensIntl.dataTable.selected[selector] === undefined) {
            GreensIntl.dataTable.selected[selector] = [];
        }
    ...
    appendToSelected(id) {
        ...
        if (! GreensIntl.dataTable.selected[this.selector].includes(id)) {
            GreensIntl.dataTable.selected[this.selector].push(id);
        }
    }
    ...
    removeFromSelected(id) {
        ...
        GreensIntl.dataTable.selected[this.selector].remove(id);
    }
    ...
    route(name, params) {
        let router = GreensIntl.dataTable.routes[this.selector][name];
    ...
    hasRoute(name) {
        return GreensIntl.dataTable.routes[this.selector][name] !== undefined;
    }

    static setRoutes(selector, routes) {
        GreensIntl.dataTable.routes[selector] = routes;
    }

    static setSelectedIds(selector, selected) {
        GreensIntl.dataTable.selected[selector] = selected;
    }

    static getSelectedIds(selector) {
        return GreensIntl.dataTable.selected[selector];
    }
