...
$(function () {
    ...
    var o = $.GreensIntl.options;

    // Set up the object
    _init();

    // Activate layout
    $.GreensIntl.layout.activate();

    // Enable sidebar tree view controls
    if (o.enableControlTreeView) {
        $.GreensIntl.tree('.sidebar');
    }

    // Activate sidebar push menu
    if (o.sidebarPushMenu) {
        $.GreensIntl.pushMenu.activate(o.sidebarToggleSelector);
    }
...
/* ----------------------------------
   - Initialize the GreensIntl Object -
   ---------------------------------- */
function _init() {
    ...
    $.GreensIntl.pushMenu = {
        activate: function (toggleBtn) {
            var screenSizes = $.GreensIntl.options.screenSizes;
    ...
    // Tree
    $.GreensIntl.tree = function (menu) {
        var animationSpeed = $.GreensIntl.options.animationSpeed;
