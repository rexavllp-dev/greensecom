...
if (! function_exists('is_core_module')) {
    ...
    {
        return in_array(strtolower($module), config('greensintl.modules.core.config.core_modules'));
    }
}
...
if (! function_exists('greensintl_version')) {
    /**
     * Get the greensintl version.
     *
     * @return string
     */
    function greensintl_version()
    {
        return GreensIntl::VERSION;
    }
}
