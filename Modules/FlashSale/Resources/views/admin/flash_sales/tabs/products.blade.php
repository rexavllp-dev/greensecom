...
@push('globals')
    <script>
        GreensIntl.data['flash_sale.products'] = {!! old_json('products', $flashSale->products) !!};
        GreensIntl.errors['flash_sale.products'] = @json($errors->get('products.*'), JSON_FORCE_OBJECT);
    </script>
@endpush
