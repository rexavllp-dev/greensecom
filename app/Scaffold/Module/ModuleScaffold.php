...
namespace GreensIntl\Scaffold\Module;

use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Facades\Artisan;
use GreensIntl\Scaffold\Module\Generators\FilesGenerator;
use GreensIntl\Scaffold\Module\Generators\EntityGenerator;
...
class ModuleScaffold
{
     ...
     *
     * @var \GreensIntl\Scaffold\Module\Generators\EntityGenerator
     */
     ...
     *
     * @var \GreensIntl\Scaffold\Module\Generators\FilesGenerator
     */
     ...
     * @param \GreensIntl\Scaffold\Module\Generators\EntityGenerator $entityGenerator
     * @param \GreensIntl\Scaffold\Module\Generators\FilesGenerator $filesGenerator
     */
...
JSON;
        ...
        $replace = <<<JSON
"description": "The GreensIntl {$moduleName} Module.",
JSON;
...
JSON;
    ...
    private function addDataToComposerJsonFile()
    {
        ...
        foreach (explode(PHP_EOL, $composerJson) as $lineNumber => $textLine) {
            if ($lineNumber === 2) {
                $composerJsonText .= "    \"description\": \"The GreensIntl {$moduleName} Module.\"," . PHP_EOL;
